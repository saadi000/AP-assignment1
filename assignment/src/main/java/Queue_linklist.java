...
public class Queue_linklist{
	...
	static public void main(String [] args){
		...
		Queue_linklist.enqueue(10);
		Queue_linklist.enqueue(20);
		Queue_linklist.enqueue(30);
		Queue_linklist.enqueue(40);

		Queue_linklist.display();
	
		Queue_linklist.dequeue();

		Queue_linklist.enqueue(50);
